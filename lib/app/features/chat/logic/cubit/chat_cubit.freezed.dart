...
class __$$CompletingImplCopyWithImpl<$Res>
    extends _$ChatStateCopyWithImpl<$Res, _$CompletingImpl>
...
class __$$CompletedImplCopyWithImpl<$Res>
    extends _$ChatStateCopyWithImpl<$Res, _$CompletedImpl>
...
class _$CompletedImpl implements _Completed {
  const _$CompletedImpl({required this.response});
  ...
  @override
  String toString() {
    return 'ChatState.completed(response: $response)';
  }
...
abstract class _Completed implements ChatState {
  const factory _Completed({required final String response}) = _$CompletedImpl;
...
class _$FailedImpl implements _Failed {
  ...
  @override
  String toString() {
    return 'ChatState.failed(error: $error)';
  }

...
import 'package:anora/app/features/chat/logic/models/anora_prompt.dart' as _i19;
...
abstract class $AppRouter extends _i18.RootStackRouter {
  ...
  final Map<String, _i18.PageFactory> pagesMap = {
    ...
    ChatRoute.name: (routeData) {
      return _i18.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i18.WrappedRoute(child: const _i3.ChatPage()),
      );
    },
    ...
    HomeRoute.name: (routeData) {
      return _i18.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i18.WrappedRoute(child: const _i7.HomePage()),
      );
    },
    ...
    LoginRoute.name: (routeData) {
      return _i18.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i18.WrappedRoute(child: const _i10.LoginPage()),
      );
    },
    ...
    ProfileRoute.name: (routeData) {
      return _i18.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i18.WrappedRoute(child: const _i13.ProfilePage()),
      );
    },
    ...
    SpaceRoute.name: (routeData) {
      return _i18.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i18.WrappedRoute(child: const _i16.SpacePage()),
      );
    },
...
class AdvancedConfigsRoute extends _i18.PageRouteInfo<void> {
  const AdvancedConfigsRoute({List<_i18.PageRouteInfo>? children})
      : super(
...
class ApperanceConfigRoute extends _i18.PageRouteInfo<void> {
  const ApperanceConfigRoute({List<_i18.PageRouteInfo>? children})
      : super(
...
class ChatroomRoute extends _i18.PageRouteInfo<ChatroomRouteArgs> {
  ...
  static const _i18.PageInfo<ChatroomRouteArgs> page =
      _i18.PageInfo<ChatroomRouteArgs>(name);
}
...
/// generated route for
/// [_i5.ChatsConfigPage]
class ChatsConfigRoute extends _i18.PageRouteInfo<void> {
  const ChatsConfigRoute({List<_i18.PageRouteInfo>? children})
      : super(
...
class DownloadsConfigRoute extends _i18.PageRouteInfo<void> {
  const DownloadsConfigRoute({List<_i18.PageRouteInfo>? children})
      : super(
...
class IntegrationTypeRoute
    extends _i18.PageRouteInfo<IntegrationTypeRouteArgs> {
  IntegrationTypeRoute({
    required _i21.Integration integration,
    _i22.Key? key,
    List<_i18.PageRouteInfo>? children,
  }) : super(
  ...
  static const _i18.PageInfo<IntegrationTypeRouteArgs> page =
      _i18.PageInfo<IntegrationTypeRouteArgs>(name);
}
...
class IntegrationTypeRouteArgs {
  ...
  final _i21.Integration integration;
...
class LanguageConfigRoute extends _i18.PageRouteInfo<void> {
  const LanguageConfigRoute({List<_i18.PageRouteInfo>? children})
      : super(
...
class MemberDetailsRoute extends _i18.PageRouteInfo<void> {
  const MemberDetailsRoute({List<_i18.PageRouteInfo>? children})
      : super(
...
class NotificationsConfigRoute extends _i18.PageRouteInfo<void> {
  const NotificationsConfigRoute({List<_i18.PageRouteInfo>? children})
      : super(
...
class SignupRouteArgs {
  ...
  final _i23.Invitation? invitation;
...
/// generated route for
/// [_i16.SpacePage]
class SpaceRoute extends _i18.PageRouteInfo<void> {
  const SpaceRoute({List<_i18.PageRouteInfo>? children})
      : super(
          SpaceRoute.name,
          initialChildren: children,
        );
